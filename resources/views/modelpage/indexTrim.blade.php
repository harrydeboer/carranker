...
<div class="modal-body">
    ...
    <table class="specsTrim">
        ...
        <tr class="row">
            ...
            <td class="col-md-6">&nbsp;{{ $trim->getFramework() ?? 'N/A' }}</td>
        </tr>
        <tr class="row">
            <td class="col-md-6"></td>
        ...
        <tr class="row">
            <td class="col-md-6">
                ...
                @endif</td>
            <td class="col-md-6">&nbsp;{{ $trim->getFuel() ?? 'N/A' }}</td>
        </tr>
        <tr class="row">
            <td colspan="2">&nbsp;</td>
        </tr>
        ...
        <tr class="row {{ $specsRange['max_trunk_capacity']['show'] === true ? '' : 'collapseSpecs' }}">
            ...
            <td class="col-md-6">&nbsp;{{ is_null($trim->getMaxTrunkCapacity()) ? 'N/A' : $trim->getMaxTrunkCapacity() .
        ...
        <tr class="row {{ $specsRange['engine_capacity']['show'] === true ? '' : 'collapseSpecs' }}">
            ...
            <td class="col-md-6">&nbsp;{{ is_null($trim->getEngineCapacity()) ? 'N/A' : $trim->getEngineCapacity() .
        ...
        <tr class="row {{ $specsRange['fueltank_capacity']['show'] === true ? '' : 'collapseSpecs' }}">
            ...
            <td class="col-md-6">&nbsp;{{ is_null($trim->getFueltankCapacity()) ? 'N/A' : $trim->getFueltankCapacity() .
        ...
        <tr class="row {{ $specsRange['max_speed']['show'] === true ? '' : 'collapseSpecs' }}">
            ...
            <td class="col-md-6">&nbsp;{{ is_null($trim->getMaxSpeed()) ? 'N/A' : $trim->getMaxSpeed() .
        ...
        <tr class="row {{ $specsRange['full_weight']['show'] === true ? '' : 'collapseSpecs' }}">
            ...
            <td class="col-md-6">&nbsp;{{ is_null($trim->getFullWeight()) ? 'N/A' : $trim->getFullWeight() .
        ...
        <tr class="row {{ $specsRange['engine_power']['show'] === true ? '' : 'collapseSpecs' }}">
            ...
            <td class="col-md-6">&nbsp;{{ is_null($trim->getEnginePower()) ? 'N/A' : $trim->getEnginePower() .
        ...
        <tr class="row {{ $specsRange['acceleration']['show'] === true ? '' : 'collapseSpecs' }}">
            ...
            <td class="col-md-6">&nbsp;{{ is_null($trim->getAcceleration()) ? 'N/A' : $trim->getAcceleration() .
        ...
        <tr class="row {{ $specsRange['fuel_consumption']['show'] === true ? '' : 'collapseSpecs' }}">
            ...
            <td class="col-md-6">&nbsp;{{ is_null($trim->getFuelConsumption()) ? 'N/A' : $trim->getFuelConsumption() .
